...
class WandbWriter(EventWriter):
    ...
    and adapted from ODISE repository.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not resume:
            ...
            os.makedirs(osp.dirname(resume_file), exist_ok=True)
    ...
    def write(self):
        ...
        self.logger.info(
            "{run_name}  {eta}iter: {iter}{max_iter}  {losses}  {time}{data_time}lr: {lr}  {memory}".format(  # noqa: E501,B950
                ...
                # NOTE: Include all the storage.histories() except for
                # non-smoothing metrics. This hack will make writer log all the metrics in
...
class WriterStack:
    """Context manager for handling writer exceptions gracefully."""
